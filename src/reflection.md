1. Things rhat arent't working or inefficiencies
...
- When I was writing the tests, I kept forgeting to add the delta for the assertEquals and that really messed up my test.
...
- The algorithm itself was probably the most challenging. I understood the concept of how it works well, but implementing it was harder that I thought it would be. This is kinda connected to the previous point since pq is a big part of making it all work correctly.